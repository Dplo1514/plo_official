...
### 1-3. MAS Architecture  
#### 1-3-1. 중앙 집중형 MAS 아키텍처
...
### 1-4. MAS Model
#### 1-4-1. Object Management Group (OMG) Model
1. 특징
...
#### 1-4-2. FIPA(Foundation for Intelligent Physical Agents) Model
1. 특징
...
3. Blue Print
   ...
   ``` 
#### 1-4-4. OAA(Open Agent Architecture) 모델:
1. 특징
